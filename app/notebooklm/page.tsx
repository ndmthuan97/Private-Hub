...
const CANONICAL_DEFAULTS: Prompt[] = [
  ...
  },
  {
    ...
    quizPrompt: `Generate exactly 30 quiz questions in English based solely on the grammar topic just explained. Questions must test whether I can correctly apply the grammar rule in real sentences — include tricky distractors that reveal common mistakes. Do not test unrelated grammar points. Number each question clearly.`,
    isDefault: true,
    sortOrder: -1,
    createdAt: new Date(0).toISOString(),
    updatedAt: new Date(0).toISOString(),
