...
import { MessageCircle, Wallet, LayoutDashboard, LogOut, Sun, Moon, Map, Plus, Globe, X, Check, CalendarDays, PanelLeftClose, PanelLeftOpen } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside
      className="flex flex-col shrink-0 sticky top-0 h-screen bg-white dark:bg-[#111] overflow-hidden z-50"
      style={{ width: expanded ? 224 : 52, transition: "width 200ms ease", boxShadow: "rgba(0,0,0,0.06) 1px 0 0 0" }}
    >
      {/* Logo */}
          ...
          {allExternal.map(item => {
            ...
            return (
              <div key={item.href} className="group/ext flex items-center">
                ...
                {/* Remove button — only custom items, only when expanded */}
